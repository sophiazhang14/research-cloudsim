...
public class CloudletSchedulerTimeShared extends CloudletScheduler {
	...
	/**
	 * CUSTOM. Vm that this cloudlet resides in.
	 */
	private Vm vm;
	...
	public void cloudletFinish(ResCloudlet rcl) {
		...
		if(vm == null) rcl.finalizeCloudlet();
		else rcl.finalizeCloudlet(vm); //CUSTOM. finalize cloudlet
	...
	public Cloudlet migrateCloudlet() {
		...
		if(vm == null) rgl.finalizeCloudlet();
		else rgl.finalizeCloudlet(vm); //CUSTOM. finalize cloudlet
